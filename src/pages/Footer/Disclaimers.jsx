...
const Disclaimers = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-green-200 dark:from-slate-900 dark:to-slate-950 text-slate-800 dark:text-slate-100 py-20 px-6 transition-colors duration-300">
      {/* ✅ SEO Integration */}
      <Seo
        title="Affiliate Disclaimer - Vitaprozen"
        description="Learn about Vitaprozen's affiliate partnerships and transparency policy. We earn small commissions through affiliate links at no extra cost to you."
        canonical="https://www.vitaprozen.com/disclaimer"
        schema={{
          "@context": "https://schema.org",
          "@type": "WebPage",
          "name": "Affiliate Disclaimer",
          "url": "https://www.vitaprozen.com/disclaimer",
          "description":
            "Vitaprozen participates in affiliate programs and may earn commissions from qualifying purchases at no extra cost to you. Learn more about our disclosure policy.",
          "mainEntity": {
            "@type": "Organization",
            "name": "Vitaprozen",
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
            We believe in full transparency. Here's everything you need to know
            about affiliate links on our platform.
          </p>
        </div>
