...
const Privacy = () => {
  const schema = {
    ...
    "@type": "WebPage",
    "name": "Privacy Policy | Vitaprozen",
    "url": "https://www.vitaprozen.com/privacy",
    "description": "We're committed to protecting your privacy and explain how we collect, use, and safeguard your data on Vitaprozen."
  };
  ...
  return (
    <>
      {/* --- SEO Setup --- */}
      <Seo
        title="Privacy Policy | Vitaprozen"
        description="We're committed to protecting your privacy and explain how we collect, use, and safeguard your data on Vitaprozen."
        canonical="https://www.vitaprozen.com/privacy"
        schema={schema}
      />
