...
import Seo from "../../components/Seo.jsx"; // Adjust path as needed

const Terms = () => {
  const schema = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "name": "Terms & Conditions | Vitaprozen",
    "url": "https://www.vitaprozen.com/terms",
    "description": "Read the Terms & Conditions for using Vitaprozen, including legal guidelines, affiliate disclosures, and site usage rules."
  };
  ...
  return (
    <>
      {/* --- SEO Setup --- */}
      <Seo
        title="Terms & Conditions | Vitaprozen"
        description="Read the Terms & Conditions for using Vitaprozen, including legal guidelines, affiliate disclosures, and site usage rules."
        canonical="https://www.vitaprozen.com/terms"
        schema={schema}
      />
